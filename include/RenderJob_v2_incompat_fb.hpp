...
#ifndef FLATBUFFERS_GENERATED_RENDERJOBV2INCOMPAT_SPEEDRACER_FB_H_
#define FLATBUFFERS_GENERATED_RENDERJOBV2INCOMPAT_SPEEDRACER_FB_H_
...
struct ImageFragmentBuffers FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const DataBuffer *index() const {
    return GetPointer<const DataBuffer *>(VT_INDEX);
  }
...
struct ImageFragmentBuffersBuilder {
  ...
  void add_index(flatbuffers::Offset<DataBuffer> index) {
    fbb_.AddOffset(ImageFragmentBuffers::VT_INDEX, index);
  }
...
inline flatbuffers::Offset<ImageFragmentBuffers> CreateImageFragmentBuffers(
    ...
    flatbuffers::Offset<DataBuffer> index = 0,
...
#endif  // FLATBUFFERS_GENERATED_RENDERJOBV2INCOMPAT_SPEEDRACER_FB_H_
